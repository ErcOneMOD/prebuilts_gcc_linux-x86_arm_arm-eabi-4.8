...
#endif
#ifdef GENERATOR_FILE
extern int warn_wrong_language;
#else
  int x_warn_wrong_language;
#define warn_wrong_language global_options.x_warn_wrong_language
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_optimize_sincos;
#else
  int x_flag_optimize_sincos;
#define flag_optimize_sincos global_options.x_flag_optimize_sincos
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_flag_optimize_sincos;
...
enum opt_code
{
  ...
  OPT_Wwrong_language = 406,                 /* -Wwrong-language */
  ...
  /* OPT_fdiagnostics_color = 536, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 537,             /* -fdiagnostics-color= */
  ...
  OPT_flto_report_wpa = 711,                 /* -flto-report-wpa */
  OPT_flto_ = 712,                           /* -flto= */
  ...
  OPT_foptimize_sincos = 760,                /* -foptimize-sincos */
  ...
  OPT_fuse_ld_mcld = 978,                    /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 979,              /* -fuse-linker-plugin */
  ...
  OPT_fvect_cost_model_ = 986,               /* -fvect-cost-model= */
  ...
  OPT_mabi_ = 1045,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1046,             /* -mabort-on-noreturn */
  OPT_mapcs = 1047,                          /* -mapcs */
  OPT_mapcs_float = 1048,                    /* -mapcs-float */
  OPT_mapcs_frame = 1049,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1050,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1051,              /* -mapcs-stack-check */
  OPT_march_ = 1052,                         /* -march= */
  OPT_marm = 1053,                           /* -marm */
  OPT_mbig_endian = 1054,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1055,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1056,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1057,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1058,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1059,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1060,                  /* -mfp16-format= */
  OPT_mfpu_ = 1061,                          /* -mfpu= */
  /* OPT_mhard_float = 1062, */              /* -mhard-float */
  OPT_minline_thumb1_jumptable = 1063,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1064,                 /* -mlittle-endian */
  OPT_mlong_calls = 1065,                    /* -mlong-calls */
  OPT_mpic_register_ = 1066,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1067,            /* -mpoke-function-name */
