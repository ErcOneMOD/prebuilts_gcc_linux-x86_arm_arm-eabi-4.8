...
enum opt_code
{
  ...
  OPT_mneon_for_64bits = 1059,               /* -mneon-for-64bits */
  OPT_mpic_register_ = 1060,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1061,            /* -mpoke-function-name */
  OPT_msched_prolog = 1062,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1063,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1064, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1065,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1066,                         /* -mthumb */
  OPT_mthumb_interwork = 1067,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1068,                  /* -mtls-dialect= */
  OPT_mtp_ = 1069,                           /* -mtp= */
  OPT_mtpcs_frame = 1070,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1071,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1072,                         /* -mtune= */
  OPT_munaligned_access = 1073,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1074,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1075,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1076,              /* -mword-relocations */
  OPT_mwords_little_endian = 1077,           /* -mwords-little-endian */
  OPT_n = 1078,                              /* -n */
  ...
  OPT_static_libstdc__ = 1123,               /* -static-libstdc++ */
  OPT_static_libtsan = 1124,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1125, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1126, */                /* -std=c++0x */
  OPT_std_c__11 = 1127,                      /* -std=c++11 */
  OPT_std_c__1y = 1128,                      /* -std=c++1y */
  OPT_std_c__98 = 1129,                      /* -std=c++98 */
  OPT_std_c11 = 1130,                        /* -std=c11 */
  /* OPT_std_c1x = 1131, */                  /* -std=c1x */
  /* OPT_std_c89 = 1132, */                  /* -std=c89 */
  OPT_std_c90 = 1133,                        /* -std=c90 */
  OPT_std_c99 = 1134,                        /* -std=c99 */
  /* OPT_std_c9x = 1135, */                  /* -std=c9x */
  OPT_std_f2003 = 1136,                      /* -std=f2003 */
  OPT_std_f2008 = 1137,                      /* -std=f2008 */
  OPT_std_f2008ts = 1138,                    /* -std=f2008ts */
  OPT_std_f95 = 1139,                        /* -std=f95 */
  OPT_std_gnu = 1140,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1141, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1142, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1143,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1144,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1145,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1146,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1147, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1148, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1149,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1150,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1151, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1152, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1153,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1154, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1155, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1156, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1157,                     /* -std=legacy */
  OPT_symbolic = 1158,                       /* -symbolic */
  OPT_t = 1159,                              /* -t */
  OPT_time = 1160,                           /* -time */
  OPT_time_ = 1161,                          /* -time= */
  OPT_traditional = 1162,                    /* -traditional */
  OPT_traditional_cpp = 1163,                /* -traditional-cpp */
  OPT_trigraphs = 1164,                      /* -trigraphs */
  OPT_u = 1165,                              /* -u */
  OPT_undef = 1166,                          /* -undef */
  OPT_v = 1167,                              /* -v */
  OPT_version = 1168,                        /* -version */
  OPT_w = 1169,                              /* -w */
  OPT_wrapper = 1170,                        /* -wrapper */
  OPT_x = 1171,                              /* -x */
  OPT_z = 1172,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
